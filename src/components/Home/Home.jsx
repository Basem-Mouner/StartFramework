    ...
    return (
      <>
        <div className="bg-[#1abc9c] flex flex-col items-center   md:mt-12 p-20">
          ...
          <div className="mt-5">
            <h2 className="md:text-6xl text-2xl  font-bold text-white text-center">start Framework</h2>
          ...
          <div className="text-white mt-5 text-center">Graphic Artist - Web Designer - Illustrator</div>
        </div>
      </>
    );
}
